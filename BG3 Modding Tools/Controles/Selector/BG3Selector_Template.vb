...
Public Class BG3Selector_Template
    Inherits BG3Selector_Generic_Code(Of BG3_Obj_Template_Class)
    ...
    Public Overrides Sub SplitGroup(sender As Object, e As EventArgs)
        ...
        For x = actualnod.Nodes.Count - 1 To 0 Step -1
            ...
            Dim selectedstat As BG3_Obj_Stats_Class = CType(CType(selectedtmp, Object), BG3_Obj_Template_Class).AssociatedStats
            ...
            Select Case queleo
                Case "Data"
                    ...
                    Else
                        suffix += selectedstat.Using
                    End If
                Case "Attribute"
                    suffix += selectedtmp.ReadAttribute_Or_Inhterithed_Or_Empty(Attr_or_data)
                Case "Custom"
                    RaiseEvent FillSplit(Attr_or_data, CType(CType(selectedtmp, Object), BG3_Obj_Template_Class), selectedstat, suffix)
                Case Else
                    Debugger.Break()
            End Select
    ...
    Public Event FillSplit(ByVal Attr_or_data As String, ByRef selectedtmp As BG3_Obj_Template_Class, ByRef selectedstat As BG3_Obj_Stats_Class, ByRef suffix As String)
