...
Public Class BG3Selector_Visuals
    Inherits BG3Selector_Generic_Code(Of BG3_Obj_VisualBank_Class)
    ...
    Public Overrides Sub SplitGroup(sender As Object, e As EventArgs)
        ...
        Dim nuevos_grupoas As New SortedList(Of String, BG3_Custom_TreeNode_Linked_Class(Of BG3_Obj_VisualBank_Class))
        For x = actualnod.Nodes.Count - 1 To 0 Step -1
            Dim nod = actualnod.Nodes(x)
            Dim selectedtmp As BG3_Obj_VisualBank_Class = CType(CType(nod, Object).objeto, BG3_Obj_VisualBank_Class)
            ...
            Select Case queleo
                ...
                Case "Custom"
                    RaiseEvent FillSplit(Attr_or_data, CType(CType(selectedtmp, Object), BG3_Obj_VisualBank_Class), suffix)
                Case Else
                    Debugger.Break()
            End Select
    ...
    Public Event FillSplit(ByVal Attr_or_data As String, ByRef selectedtmp As BG3_Obj_VisualBank_Class, ByRef suffix As String)
