...
Public MustInherit Class Editor_Visuals_GenericAttribute
    ...
    End Function
    Public Overrides Function Create(value As String, Que As BG3_Obj_VisualBank_Class) As Boolean
    ...
    Public Overrides Function Conditional_GetParent_Value(Parent As BG3_Obj_VisualBank_Class) As String
        Dim str = Parent.ReadAttribute_Or_Inhterithed(Key)
        If IsNothing(str) Then Return ""
        Return str
    End Function
    Public Overrides Function Conditional_Changed(Que As BG3_Obj_VisualBank_Class) As Boolean
        ...
        Return Get_ValueString(value)
    End Function
    Public Overrides Function Conditional_changed_Empty(Que As BG3_Obj_VisualBank_Class) As LSLib.LS.NodeAttribute
        Dim value As LSLib.LS.NodeAttribute = Nothing
        Dim current = Que
    ...
    Public Overridable Function Get_ValueString(ByRef value As LSLib.LS.NodeAttribute) As Boolean
        ...
        Return True
    End Function
    Public Overridable Function Set_ValueString(Que As BG3_Obj_VisualBank_Class) As String
...
Public MustInherit Class Editor_Visuals_GenericTranslate
    ...
    Public Function GetPropertyName() As String
        Return Key
    End Function
    Public Function Get_Utam_Handle(Que As BG3_Obj_VisualBank_Class) As String
        Dim value As LSLib.LS.NodeAttribute = Nothing
        ...
        Return _LastHandle
    End Function
    Public Function Get_inherited_Handle(Que As BG3_Obj_VisualBank_Class) As String
        If IsNothing(Que.Parent) Then Return Nothing
        Return Que.Parent.ReadAttribute_Or_Inhterithed(Key)
    End Function
    Public Function Get_Current_Handle(Que As BG3_Obj_VisualBank_Class) As String
    ...
    Public Overrides Function Conditional_GetParent_Value(Parent As BG3_Obj_VisualBank_Class) As String
        ...
        Return ""
    End Function
    Public Overrides Function Set_ValueString(Que As BG3_Obj_VisualBank_Class) As String
        Dim value As LSLib.LS.NodeAttribute = Nothing
...
Public MustInherit Class Combobox_Editor_Visuals_GenericAttribute
    Inherits Editor_Visuals_GenericAttribute
    Sub New(Key As String)
        Me.Key = Key
...
Public MustInherit Class Numeric_Editor_Visuals_GenericAttribute
    Inherits Editor_Visuals_GenericAttribute
    Sub New(Key As String, AttributeType As LSLib.LS.AttributeType)
        Me.Key = Key
        Me.AttributeType = AttributeType
