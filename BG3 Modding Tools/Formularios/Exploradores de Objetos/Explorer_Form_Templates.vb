...
Public Class Explorer_Form_Templates
    ...
    Private Sub Template_Explorer_Form_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        Dim visual As New Template_Information_Form(MdiParent, Me) With {.StartPosition = FormStartPosition.Manual, .Location = New Point(Left() + Width, Top), .Height = Height}
