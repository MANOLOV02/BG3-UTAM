...
Public Class Information_Form_VisualTemplates
    ...
    Sub New(MdiParent As Main, ObjectExplorer As Explorer_Form_VisualTemplates)
    ...
    Public Overrides Sub Pone_info(obj As Object)
        Pone_info(CType(obj, BG3_Obj_VisualBank_Class))
    End Sub
    Public Overloads Sub Pone_info(obj As BG3_Obj_VisualBank_Class)
        LastObject = obj
        ...
        Else
            XmLtoRichText2.Process_Visual(obj)
        End If
