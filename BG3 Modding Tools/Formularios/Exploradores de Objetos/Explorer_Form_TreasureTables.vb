...
Public Class Explorer_Form_TreasureTables
    ...
    Private Sub Template_Explorer_Form_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        Dim visual As New Information_Form_TreasureTables(MdiParent, Me) With {.StartPosition = FormStartPosition.Manual, .Location = New Point(Left() + Width, Top), .Height = Height}
    ...
    Public Overrides Sub BackgroundWork_Finished_Sub()
        ...
        ObjectsTree.ObjectList = FuncionesHelpers.GameEngine.ProcessedTTables
