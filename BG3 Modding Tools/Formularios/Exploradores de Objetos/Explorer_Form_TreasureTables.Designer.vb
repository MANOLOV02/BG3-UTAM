...
Partial Class Explorer_Form_TreasureTables
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Explorer_Form_Stats))
        ObjectsTree = New BG3Explorer_TreasureTables()
        SuspendLayout()
        ' 
        ' StatsTree1
        ' 
    ...
    Friend WithEvents ObjectsTree As BG3Explorer_TreasureTables
