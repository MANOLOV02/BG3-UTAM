...
#Disable Warning CA1861 ' Evitar matrices constantes como argumentos
        Lista.AddRange({
            New ToolStripMenuItem("Consumables specific|Use type|True|Data", Nothing, AddressOf BG3Selector_Template1.TransferSibligsClick) With {.Tag = {"ItemUseType"}},
              New ToolStripMenuItem("Consumables specific|Supply value|False|Data", Nothing, AddressOf BG3Selector_Template1.TransferSibligsClick) With {.Tag = {"SupplyValue"}},
                New ToolStripMenuItem("Consumables specific|Use conditions|True|Data", Nothing, AddressOf BG3Selector_Template1.TransferSibligsClick) With {.Tag = {"UseConditions"}}
            })
