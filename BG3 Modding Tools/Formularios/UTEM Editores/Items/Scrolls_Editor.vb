...
Public Class Scrolls_Editor

    Protected Overrides ReadOnly Property Prefix As String = "UTAM_Scroll_"
    Protected Overrides ReadOnly Property UtamType As BG3_Enum_UTAM_Type = BG3_Enum_UTAM_Type.Scrolls
    Protected Overrides ReadOnly Property DefaulStatUsing As String = "_MagicScroll"
    Protected Overrides ReadOnly Property DefaulParent As String = "4ffd5c4b-4c56-4f05-a228-a33754bb1806"
...
#Disable Warning CA1861 ' Evitar matrices constantes como argumentos
        Lista.AddRange({
            New ToolStripMenuItem("Scroll specific|Use type|True|Data", Nothing, AddressOf BG3Selector_Template1.TransferSibligsClick) With {.Tag = {"ItemUseType"}},
                New ToolStripMenuItem("Scroll specific|Use conditions|True|Data", Nothing, AddressOf BG3Selector_Template1.TransferSibligsClick) With {.Tag = {"UseConditions"}}
            })
