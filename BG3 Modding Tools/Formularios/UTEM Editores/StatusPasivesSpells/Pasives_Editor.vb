...
Public Class Pasives_Editor
    Protected Overrides Property Stattype As BG3_Enum_StatType = BG3_Enum_StatType.PassiveData
    Protected Overrides ReadOnly Property UtamType As BG3_Enum_UTAM_Type = BG3_Enum_UTAM_Type.Passives
    Sub New()
