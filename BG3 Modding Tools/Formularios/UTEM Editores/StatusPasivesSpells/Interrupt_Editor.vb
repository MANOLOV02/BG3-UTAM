...
Public Class Interrupt_Editor
    Protected Overrides Property Stattype As BG3_Enum_StatType = BG3_Enum_StatType.InterruptData
    Protected Overrides ReadOnly Property UtamType As BG3_Enum_UTAM_Type = BG3_Enum_UTAM_Type.Interrupt
    Sub New()
