...
Partial Class ProcesarPaks
    ...
    Private Sub InitializeComponent()
        ...
        Button1 = New Button()
        TextBoxUTAMCacheFolder = New TextBox()
        Button4 = New Button()
        Label4 = New Label()
        ...
        ' TextBoxModFolder
        ' 
        TextBoxModFolder.Location = New Point(157, 35)
        ...
        ' Button2
        ' 
        Button2.Location = New Point(487, 12)
        ...
        ' Button3
        ' 
        Button3.Location = New Point(487, 35)
        ...
        ' TreeViewPacks
        ' 
        TreeViewPacks.Location = New Point(12, 299)
        TreeViewPacks.Name = "TreeViewPacks"
        TreeViewPacks.Size = New Size(513, 247)
        ...
        ' 
        TextBoxUTAMModFolder.Location = New Point(157, 58)
        ...
        ' Button1
        ' 
        Button1.Location = New Point(487, 58)
        ...
        ' 
        ' TextBoxUTAMCacheFolder
        ' 
        TextBoxUTAMCacheFolder.Location = New Point(157, 81)
        TextBoxUTAMCacheFolder.Name = "TextBoxUTAMCacheFolder"
        TextBoxUTAMCacheFolder.ReadOnly = True
        TextBoxUTAMCacheFolder.Size = New Size(324, 23)
        TextBoxUTAMCacheFolder.TabIndex = 18
        ' 
        ' Button4
        ' 
        Button4.Location = New Point(487, 81)
        ...
        Controls.Add(TextBoxUTAMCacheFolder)
    ...
    Friend WithEvents TextBoxUTAMCacheFolder As TextBox
